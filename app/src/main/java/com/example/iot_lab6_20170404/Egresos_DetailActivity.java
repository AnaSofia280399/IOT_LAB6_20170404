...
public class Egresos_DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egresos_detail);
        ...
        ingreso_descripcion = findViewById(R.id.egreso_detailDesc);
        ingreso_fecha = findViewById(R.id.egreso_detailFecha);
        ingreso_titulo = findViewById(R.id.egreso_detailTitle);
        ingreso_monto = findViewById(R.id.egreso_detailMonto);

        editButton = findViewById(R.id.egreso_edit_button);
        deleteButton = findViewById(R.id.egreso_delete_button);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful() && !task.getResult().isEmpty()) {
                                ...
                                Toast.makeText(Egresos_DetailActivity.this, "Credenciales incorrectas", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        ...
        editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Egresos_DetailActivity.this, Egresos_EditActivity.class)
                    ...
                    db.collection("usuarios_por_auth")
                            ...
                            .addOnCompleteListener(task -> {
                                if (task.isSuccessful() && !task.getResult().isEmpty()) {
                                    ...
                                    docRef.delete()
                                            .addOnSuccessListener(aVoid -> Toast.makeText(Egresos_DetailActivity.this, "Ingreso eliminado", Toast.LENGTH_SHORT).show())
                                            .addOnFailureListener(e -> Toast.makeText(Egresos_DetailActivity.this, "Error al eliminar ingreso", Toast.LENGTH_SHORT).show());
                                } else {
                                    Toast.makeText(Egresos_DetailActivity.this, "Ingreso no encontrado", Toast.LENGTH_SHORT).show();
                                }
                            });
                } else {
                    Toast.makeText(Egresos_DetailActivity.this, "No está logueado", Toast.LENGTH_SHORT).show();
                }


                Intent intent = new Intent(Egresos_DetailActivity.this, EgresosActivity.class);
                startActivity(intent);
