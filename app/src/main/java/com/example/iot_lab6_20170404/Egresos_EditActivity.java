...
public class Egresos_EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_egresos_edit);
        ...
        edit_descripcion = findViewById(R.id.descripcion_editEgreso);
        edit_fecha = findViewById(R.id.fecha_editEgreso);
        edit_titulo = findViewById(R.id.titulo_editEgreso);
        edit_monto = findViewById(R.id.monto_editEgreso);
        String uid = currentUser.getUid();

        guardar_editButton = findViewById(R.id.boton_guardarEditEgreso);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful() && !task.getResult().isEmpty()) {
                                ...
                                Toast.makeText(Egresos_EditActivity.this, "Credenciales incorrectas", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
        ...
        guardar_editButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Egresos_EditActivity.this);
                    ...
                    db.collection("usuarios_por_auth")
                            ...
                            .addOnCompleteListener(task -> {
                                if (task.isSuccessful() && !task.getResult().isEmpty()) {
                                    ...
                                    Egreso egreso = new Egreso(descripcion, fecha, titulo, monto, id);

                                    // Actualizar el documento encontrado
                                    docRef.set(egreso)
                                            .addOnSuccessListener(aVoid -> Toast.makeText(Egresos_EditActivity.this, "Egreso actualizado", Toast.LENGTH_SHORT).show())
                                            .addOnFailureListener(e -> Toast.makeText(Egresos_EditActivity.this, "Error al actualizar ingreso", Toast.LENGTH_SHORT).show());
                                } else {
                                    Toast.makeText(Egresos_EditActivity.this, "Egreso no encontrado", Toast.LENGTH_SHORT).show();
                                }
                            });
                } else {
                    Toast.makeText(Egresos_EditActivity.this, "No está logueado", Toast.LENGTH_SHORT).show();
                }

                dialog.dismiss();

                Intent intent = new Intent(Egresos_EditActivity.this, EgresosActivity.class);
                startActivity(intent);
