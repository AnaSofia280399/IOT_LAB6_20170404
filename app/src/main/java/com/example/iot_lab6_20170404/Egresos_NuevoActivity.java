...
public class Egresos_NuevoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nuevo_descripcion = findViewById(R.id.descripcion_nuevoEngreso);
        nuevo_fecha = findViewById(R.id.fecha_nuevoEgreso);
        nuevo_titulo = findViewById(R.id.titulo_nuevoEgreso);
        nuevo_monto = findViewById(R.id.monto_nuevoEgreso);
        String uid = currentUser.getUid();




        guardarButton = findViewById(R.id.boton_guardarNuevoEgreso);

        guardarButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Egresos_NuevoActivity.this);
                ...
                Egreso egreso = new Egreso(descripcion, fecha_registro,titulo, monto , fecha_registro + String.format("%.2f", monto));
                ...
                if(currentUser != null){
                    ...
                    db.collection("usuarios_por_auth")
                            ...
                            .addOnSuccessListener(unused -> {
                                Toast.makeText(Egresos_NuevoActivity.this, "Saved", Toast.LENGTH_SHORT).show();
                            })
                            .addOnFailureListener(e ->{
                                Toast.makeText(Egresos_NuevoActivity.this, "Algo paso al guardar", Toast.LENGTH_SHORT).show();

                            });
                }else {
                    Toast.makeText(Egresos_NuevoActivity.this, "No esta logueado", Toast.LENGTH_SHORT).show();
                ...
                dialog.dismiss();
                Intent intent = new Intent(Egresos_NuevoActivity.this, EgresosActivity.class);
                startActivity(intent);
            }
        });
